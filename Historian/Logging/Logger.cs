...
namespace Historian.Logging
{
    ...
    public class Logger : ILogger
    {
        ...
        /// <returns></returns>
        public void Log(object sourceOfLogMsg, Action<ILog> logAction)
        {
            Log(sourceOfLogMsg.GetType(), logAction);
        }
        ...
        /// <param name="logAction">The log action to perform for each logger registered</param>
        /// <returns></returns>
        public void Log<TSourceOfLogMsg>(Action<ILog> logAction)
        {
            Log(typeof(TSourceOfLogMsg), logAction);
        }
        ...
        /// <param name="logAction">The log action to perform for each logger registered</param>
        /// <returns></returns>
        public void Log(Type sourceOfLogMsg, Action<ILog> logAction)
        {
